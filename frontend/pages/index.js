...
export default function Home() {
  ...
  function renderCreateProposalTab() {
    if (loading) {
      ...
      return (
        <div className={styles.description}>
          You do not own any Alien NFTs. <br />
  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Alien DAO" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Alien Planet!</h1>
          <div className={styles.description}>Welcome to the DAO!</div>
          <div className={styles.description}>
            Your Alien NFT Balance: {nftBalance}
            <br />
        ...
        <div>
          <img className={styles.image} src="/alien/0.svg" />
        </div>
      </div>
